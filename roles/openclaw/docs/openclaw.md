...
This role follows the official Docker installation path documented here: <https://docs.openclaw.ai/install/docker>.

## Usage

Set `openclaw_enabled: true` in your `inventories/<your_inventory>/group_vars/nas.yml` file.

The OpenClaw Control UI can be found at <http://ansible_nas_host_or_ip:18789>.
...
The upstream OpenClaw docs treat Docker as optional overall, but this Ansible-NAS role intentionally uses the official Docker deployment option.